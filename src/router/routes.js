...
export default [
	{
		...
		children: [
			...
			{ path: '/admin/personal/:id?', 		component: () => import ('pages/index'), 						meta: { name: "Перонал" } },
			...
			{ path: '/profile/:id?', 				component: () => import ('pages/main/profile'), 				meta: { name: "Профиль" } },
			...
			{ path: '/docs/shipments/:id?', 		component: () => import ('pages/furniture/new'), 				meta: { name: "Доставки" } },
