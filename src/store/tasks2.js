...
const mutations = {
	...
	updateEditTaskFormVisible(store, payload){
		store.task_edit_visible = payload
	},
...
const getters = {
	...
	task_edit_visible: ({ task_edit_visible }) => task_edit_visible,
	task_edit_current: ({ currentEdited }) => currentEdited
}
